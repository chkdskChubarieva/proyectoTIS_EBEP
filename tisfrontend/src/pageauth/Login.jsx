...
const Login = () => {
    ...
    useEffect(() => {
        ...
        return () => {
            if (showPasswordCheckboxRef1.current && passwordInputRef1.current) {
                showPasswordCheckboxRef1.current.removeEventListener(
                    "change",
                    () =>
                        togglePasswordVisibility(
                            passwordInputRef1,
            ...
            if (showPasswordCheckboxRef2.current && passwordInputRef2.current) {
                showPasswordCheckboxRef2.current.removeEventListener(
                    "change",
                    () =>
                        togglePasswordVisibility(
                            passwordInputRef2,
            ...
            if (botonEstudianteForm2Ref.current) {
                botonEstudianteForm2Ref.current.removeEventListener(
                    "click",
                    () =>
                        switchFormVisibility(formEstudianteRef, formDocenteRef)
                );
